...
:::tip[Go deeper]
Each component box above links to its own page. For the current implementation,
browse the source and the authoritative `docs/` (architecture, glossary, API guide).
:::
